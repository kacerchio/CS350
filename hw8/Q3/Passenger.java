...
public class Passenger extends Thread { 
  ...
  public void run() {
    ...
    while(true) {
      ...
      System.out.println("Passenger " + this.id + " is waiting for a shuttle at terminal " + this.st);
      signal(Controller.mutex); 
      
      wait(Controller.enterLock[this.st]);
      System.out.println("Passenger " + this.id + " is entering a shuttle at terminal " + this.st); 
      
      wait(Controller.mutex);
      Controller.dropOffRequests[this.dt]++; 
      System.out.println("Passenger " + this.id + " is on a shuttle en route to terminal " + this.dt);
      signal(Controller.mutex); 
      
      wait(Controller.exitLock[this.dt]); 
      System.out.println("Passenger " + this.id + " is exiting a shuttle at terminal " + this.dt); 
